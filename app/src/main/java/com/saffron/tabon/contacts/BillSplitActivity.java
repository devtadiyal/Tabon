...
public class BillSplitActivity extends AppCompatActivity {
    ...
    private List<BillSplitGetter> list1 = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bill_split);

        TextView t = findViewById(R.id.viewbill);
        ...
        Button b = findViewById(R.id.sharebill);
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(BillSplitActivity.this,TotalBillActivity.class));
            }
        });
        ...
        for (int k = 0; k < p.size(); k++) {
            ...
            BillSplitGetter listItem = new BillSplitGetter(gg, aa, no);
            list1.add(listItem);

        }

        adapter = new BillSplitAdapter(list1, this);
