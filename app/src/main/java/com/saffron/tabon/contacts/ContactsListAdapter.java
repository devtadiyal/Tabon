...
public class ContactsListAdapter extends BaseAdapter {
    ...
    int minteger = 0,checkbox_clicked;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.chkContact = convertView.findViewById(R.id.chk_contact);

            viewHolder.txt = convertView.findViewById(R.id.name1);
        ...
        viewHolder.txt.setText(this.filteredContactsList.contactArrayList.get(position).toString());
        ...
        viewHolder.chkContact.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (contact != null && isChecked && !alreadySelected(contact)) {
                    ...
                    ((ContactsPickerActivity) context).clickItem(position, true);
                    String aa = viewHolder.txt.getText().toString();
                    al.add(aa);
                    increaseInteger();
                } else if (contact != null && !isChecked) {
                    selectedContactsList.removeContact(contact);
                    System.out.println("UNCHECK BOX");
                    ((ContactsPickerActivity) context).clickItem(position, false);
                    decreaseInteger();
                }
            }
        });
    ...
    private void display(int number) {
        ...
        checkbox_clicked = number;
       System.out.println("CHECKBOX CLICK "+number);
    }
