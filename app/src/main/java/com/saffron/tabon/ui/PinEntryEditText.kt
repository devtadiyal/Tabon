...
class PinEntryEditText : android.support.v7.widget.AppCompatEditText {
    ...
    protected lateinit var mLineCoords: ArrayList<RectF>
    ...
    protected var mLineStrokeSelected = 3f //2dp by default
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        mLineCoords = ArrayList<RectF>()
        mLineCoords.add(RectF(0F, 0F, 0F, 0F))
        mLineCoords.add(RectF(0F, 0F, 0F, 0F))
        mLineCoords.add(RectF(0F, 0F, 0F, 0F))
        mLineCoords.add(RectF(0F, 0F, 0F, 0F))
